...
public class Dispatch extends Thread{
	 ...
	 * 抽象函数：AF(c)=(map, alltaxi, orderlist) where map==c.map, 
	 * 				alltaxi==c.alltaxi, orderlist==c.orderlist
	 * 不变式：c.map!=null && c.alltaxi!=null && c.orderlist!=null 
	 * 		&& c.alltaxi.length<=100
	 * */
