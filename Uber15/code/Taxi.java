...
public class Taxi extends Thread{
	 ...
	 * 抽象函数：AF(c)=(No, type, state, credit, x, y, lastx, lasty, order, map, gui, road, light)  
	         where No==c.No, type==c.type, state==c.state, credit==c.credit, x==c.x, y==c.y,
	         lastx==c.lastx, lasty==c.lasty, order==c.order, map==c.map, gui==c.gui,
	         road==c.road, light==c.light
	...
	{
		/*@Requires:获得地图上每一条边的开关情况、流量及红绿灯方向
		  @Modifies:GUI, this
